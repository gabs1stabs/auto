    ...
    <nav className="w-full z-[1000] lg:mt-2 2xl:mt-3 4xl:mt-4 6xl:mt-5">
      ...
      lg:p-[10px]  4xl:p-[12px_10px] 6xl:p-[14px_12px] 7xl:p-[16px_13px] ">
        <div className="flex items-center lg:gap-2 2xl:gap-3.5 1xl:gap-6 xl:ml-4 mr-0 6xl:ml-7 8xl:ml-10 1xl:ml-14 ">
          <a href="https://www.facebook.com/"><div className="bg-white py-[6px]  px-[8px] xl:py-[6px] 2xl:py-[7px] 2xl:px-[11px] 6xl:py-[10px] 6xl:px-[13px] 8xl:py-[13px] 8xl:px-[16px] 1xl:py-[16px] 1xl:px-[20px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/facebook.svg"  alt="" className="lg:h-[19px] lg:w-[19px] 2xl:w-[30px] 2xl:h-[30px] 4xl:w-[31px] 4xl:h-[31px] 6xl:w-[33px] 6xl:h-[33px] 8xl:h-[36px] 8xl:w-[36px] 1xl:h-[39px] 1xl:w-[39px]" /></div></a>
          <a href="https://www.instagram.com/"><div className="bg-white py-[6px]  px-[8px] xl:py-[5px] 2xl:py-[6px] 2xl:px-[11px] 6xl:py-[10px] 6xl:px-[13px] 8xl:py-[13px] 8xl:px-[16px] 1xl:py-[16px] 1xl:px-[20px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/instagram.svg"  alt="" className="lg:h-[24px] lg:w-[24px] 2xl:w-[33px] 2xl:h-[33px] 4xl:w-[34px] 4xl:h-[34px] 6xl:w-[36px] 6xl:h-[36px] 8xl:h-[39px] 8xl:w-[39px] 1xl:h-[42px] 1xl:w-[42px]" /></div></a>
          <a href="https://www.tiktok.com/"><div className="bg-white py-[6px]  px-[8px] xl:py-[6px] 2xl:py-[7px] 2xl:px-[11px] 6xl:py-[10px] 6xl:px-[13px] 8xl:py-[13px] 8xl:px-[16px] 1xl:py-[16px] 1xl:px-[20px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/tiktok.svg"  alt="" className="lg:h-[19px] lg:w-[19px] 2xl:w-[30px] 2xl:h-[30px] 4xl:w-[31px] 4xl:h-[31px] 6xl:w-[33px] 6xl:h-[33px] 8xl:h-[36px] 8xl:w-[36px] 1xl:h-[39px] 1xl:w-[39px]" /></div></a>
        </div>
