...
<div className='relative md:mt-[160px] mt-[-800px] lg:mt-[150px] xl:mt-[70px] 2xl:mt-[-900px] '>
  <div className="absolute 2xl:top-16 md:top-12 top-8 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 flex items-center justify-center w-[800px]">
    <div className="lg:m-[10px] mr-1 sm:ml-2 2xl:m-[14px] ">
      <img src="/pics/design-w1.png" alt="Design" className="md:w-[110px] 2xl:w-[160px] 2xl:h-[40px] md:h-[30px] w-[80px] h-[20px] sm:h-[22px] sm:w-[146px]" />
    </div>
    ...
    <div className="lg:m-[10px] ml-1 sm:ml-0 2xl:m-[14px]">
      <img src="/pics/design-w.png" alt="Design" className="md:w-[110px] 2xl:w-[160px]  2xl:h-[40px] md:h-[30px] w-[80px] h-[20px] sm:h-[20px] sm:w-[146px]" />
    </div>
